...
router.post('/registrar', async (req, res) => {
  const { empleado_id, estado, nivelAlcohol } = req.body;

  console.log('Datos recibidos para registrar asistencia:', { empleado_id, estado, nivelAlcohol });
  ...
  try {
    const nuevaAsistencia = await AsistenciaEmpleados.create({
      ...
      nivelAlcohol: nivelAlcohol || 0, // Nivel de alcohol, por defecto 0
    });
